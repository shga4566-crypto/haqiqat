        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex gap-4 w-full">
              <button 
                onClick={handleCancel}
                className="flex-1 py-3 rounded-xl border border-black/10 dark:border-white/10 text-black/80 dark:text-white/80 hover:bg-black/5 dark:hover:bg-white/5 transition-all font-bold"
              >
                نا
              </button>
              <button 
                onClick={handleConfirmExit}
                className="flex-1 py-3 rounded-xl bg-gold-dark dark:bg-gold text-white dark:text-black font-bold hover:bg-gold transition-all"
              >
                هو
              </button>
            </div>
